		...
		///start menu
		{
			...
			//-------------------------------------------------------------------------//
			 case(12):
					 if(flagAdd==1)
					 {
						 porcentajeClientesProcesados(clientE,requestE,basurA,LENGTH,LENGTH2);
					 }
					 else
					 {
						 printf("\n Debe cargar un cliente para mostrarlo!!");
			...
			case(14):
					if(flagAdd==1)
					{
						ppReciclado(clientE,requestE,basurA,LENGTH,LENGTH2);
					}
					else
					{
						printf("\n Debe cargar un cliente para mostrarlo!!");
			...
			case(15):
					if(flagAdd==1)
					{
						buscaCuitReciclado(clientE,requestE,basurA,LENGTH,LENGTH2);
					}
					else
					{
						printf("\n Debe cargar un cliente para mostrarlo!!");
